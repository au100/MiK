...
<div class="logo">
 <h1 class="logo-name"><a href="<?php echo $document->baseurl; ?>/"><?php echo $this->params->get('siteTitle'); ?></a></h1>
 <h2 class="logo-text"><?php echo $this->params->get('siteSlogan'); ?></h2>
</div>
    ...
    <div class="footer-body">
        <?php echo $view->position('syndicate'); ?>
                <div class="footer-text">
                    ...
                    <?php else: ?>
                    <?php ob_start(); ?>
<p><a href="http://karlson-bl.in/forum/ucp.php?mode=register&sid=19f3fce133d5cf41e57c5a41e8a76762">Регистрация</a></p><p>Малыш и Карлсон BL © 2011-2012</p>
