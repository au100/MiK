        ...
        <div class="adminform">
            ...
            <div style="float: right;">
                <span class="button-wrapper">
                    ...
                    <input type="button" class="button" onclick="submitbutton('save')" value="<?php echo JText::_('Save') ?>"/>
                </span>
                <span class="button-wrapper">
                    <span class="button-l"> </span>
                    <span class="button-r"> </span>
                    <input type="button" class="button" onclick="submitbutton('cancel')" value="<?php echo JText::_('Cancel') ?>"/>
                </span>
            </div>
