...
$plg_return = rok_plugin_uninstall(&$this, "phpbb3_auth", "authentication", $rok_database);
$rok_install_status['phpBB3 Authentication Plugin'] = $plg_return;
if ($plg_return->status == $plg_return->STATUS_FAIL) {
    var_dump ($plg_return);
}

$plg_return = rok_plugin_uninstall(&$this, "phpbb3_user", "user", $rok_database);
...
?>
<h1>RokBridge Uninstallation</h1>
