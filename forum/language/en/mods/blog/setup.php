...
$lang = array_merge($lang, array(
	...
	'WELCOME_MESSAGE'				=> 'Добро пожаловать в Блог форума Karlson-bl!

 Если у Вас есть предложения по улучшению возможностей, пожалуйста, обращайтесь к администрации форума.',

        'WELCOME_SUBJECT'                                => 'Добро пожаловать в Блог форума Karlson-bl!',
));
