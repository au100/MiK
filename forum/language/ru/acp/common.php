...
$lang = array_merge($lang, array(
	'ACP_REPUTATION_SETTINGS'	=> 'Настройки параметров репутации',
	'ACP_MANAGE_REP_RANKS'		=> 'Управление оценками репутаций',
	'LOG_CONFIG_REPUTATION'		=> '<strong>Настройки пользовательской репутацией изменена</strong>',
	'LOG_RP_RANK_ADDED'		=> '<strong>Добавлена новая оценка репутации</strong><br />» %s',
	'LOG_RP_RANK_REMOVED'		=> '<strong>Оценка репутации удалена</strong><br />» %s',
	'LOG_RP_RANK_UPDATED'		=> '<strong>Оценка репутации сохранена</strong><br />» %s',
	'LOG_USER_UPDATE_REPUTATION'	=> '<strong>Управление репутациями изменено</strong><br />» from “%2$s” to “%3$s”',
	'LOG_RESET_REPUTATION'		=> '<strong>Сброс пераметров репутации</strong>',
));
// end of added
