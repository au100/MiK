...
<?php } if ($this->_rootref['S_CAN_HIDE_REPUTATION']) {  ?>	
	<tr> 
		<td class="row1" width="50%"><b class="genmed"><?php echo ((isset($this->_rootref['L_RP_HIDE'])) ? $this->_rootref['L_RP_HIDE'] : ((isset($user->lang['RP_HIDE'])) ? $user->lang['RP_HIDE'] : '{ RP_HIDE }')); ?>:</b></td>
		<td class="row2"><input type="radio" class="radio" name="hidereputation" value="1"<?php if ($this->_rootref['S_HIDE_REPUTATION']) {  ?> checked="checked"<?php } ?> /><span class="genmed"><?php echo ((isset($this->_rootref['L_YES'])) ? $this->_rootref['L_YES'] : ((isset($user->lang['YES'])) ? $user->lang['YES'] : '{ YES }')); ?></span>&nbsp;&nbsp;<input type="radio" class="radio" name="hidereputation" value="0"<?php if (! $this->_rootref['S_HIDE_REPUTATION']) {  ?> checked="checked"<?php } ?> /><span class="genmed"><?php echo ((isset($this->_rootref['L_NO'])) ? $this->_rootref['L_NO'] : ((isset($user->lang['NO'])) ? $user->lang['NO'] : '{ NO }')); ?></span></td>
	</tr>
