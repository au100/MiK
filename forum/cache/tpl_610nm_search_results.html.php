	...
	<?php $_searchresults_count = (isset($this->_tpldata['searchresults'])) ? sizeof($this->_tpldata['searchresults']) : 0;if ($_searchresults_count) {for ($_searchresults_i = 0; $_searchresults_i < $_searchresults_count; ++$_searchresults_i){$_searchresults_val = &$this->_tpldata['searchresults'][$_searchresults_i]; if ($_searchresults_val['S_DELETED']) {  ?>
		...
		<tr valign="middle" class="deleted_topic">
			...
			<td class="row1" colspan="5">
				...
				<?php echo $_topicrow_val['ATTACH_ICON_IMG']; ?> <a href="<?php echo $_searchresults_val['U_VIEW_TOPIC']; ?>" class="topictitle"><?php if ($_searchresults_val['TOPIC_TITLE_COLOUR']) {  ?><span style="color: #<?php echo $_searchresults_val['TOPIC_TITLE_COLOUR']; ?>"><?php } echo $_searchresults_val['TOPIC_TITLE']; if ($_searchresults_val['TOPIC_TITLE_COLOUR']) {  ?></span><?php } ?></a>
	...
	<?php } else { ?>
		...
		<tr valign="middle">
			...
			<td class="row1">
				...
				<?php echo $_searchresults_val['ATTACH_ICON_IMG']; ?> <a href="<?php echo $_searchresults_val['U_VIEW_TOPIC']; ?>"   <?php if ($_searchresults_val['FIRST_TEXT_HOVER']) {  ?>title="<?php echo $_searchresults_val['FIRST_TEXT_HOVER']; ?>"<?php } ?>  class="topictitle"> <?php if ($_searchresults_val['TOPIC_TITLE_COLOUR']) {  ?><span style="color: #<?php echo $_searchresults_val['TOPIC_TITLE_COLOUR']; ?>"><?php } ?> <?php echo $_searchresults_val['TOPIC_TITLE']; if ($_searchresults_val['TOPIC_TITLE_COLOUR']) {  ?></span><?php } ?></a>
			...
			<td class="row1" width="120" align="center">
				...
				<p class="topicdetails"><?php echo $_searchresults_val['LAST_POST_AUTHOR_FULL']; ?>
					...
					<a href="<?php echo $_searchresults_val['U_LAST_POST']; ?>"   <?php if ($_searchresults_val['LAST_TEXT_HOVER']) {  ?>title="<?php echo $_searchresults_val['LAST_TEXT_HOVER']; ?>"<?php } ?>  >  <?php if ($_searchresults_val['LAST_TEXT_HOVER']) {  echo $_searchresults_val['LAST_POST_IMG']; } else { ?> <?php echo (isset($this->_rootref['LAST_POST_IMG'])) ? $this->_rootref['LAST_POST_IMG'] : ''; ?>  <?php } ?> </a>
				</p>
			</td>
		</tr>
	<?php } }} else { ?>
