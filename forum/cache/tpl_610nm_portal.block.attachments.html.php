<?php if (!defined('IN_PHPBB')) exit; ?><table class="tablebg" cellspacing="1" width="100%">
	<tr>
		<th><?php echo ((isset($this->_rootref['L_ATTACHMENTS'])) ? $this->_rootref['L_ATTACHMENTS'] : ((isset($user->lang['ATTACHMENTS'])) ? $user->lang['ATTACHMENTS'] : '{ ATTACHMENTS }')); ?></th>
	</tr>
	<tr class="row1">
		<td>	
			...
			<span style="float:right;padding-right:10px;" class="gensmall"><?php echo $_attach_val['FILESIZE']; ?></span>
			<br style="clear:both" />
            <?php }} ?>
		</td>
	</tr>
