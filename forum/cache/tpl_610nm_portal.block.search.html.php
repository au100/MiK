<?php if (!defined('IN_PHPBB')) exit; ?><script language="JavaScript" type="text/javascript">
<!--
...
<table class="tablebg" cellspacing="1" width="100%">
	<tr>
		<th><?php echo ((isset($this->_rootref['L_SEARCH'])) ? $this->_rootref['L_SEARCH'] : ((isset($user->lang['SEARCH'])) ? $user->lang['SEARCH'] : '{ SEARCH }')); ?></th>
	</tr>
	<tr class="row1">
		<td>
