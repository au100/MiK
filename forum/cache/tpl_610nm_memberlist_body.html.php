...
<?php $_memberrow_count = (isset($this->_tpldata['memberrow'])) ? sizeof($this->_tpldata['memberrow']) : 0;if ($_memberrow_count) {for ($_memberrow_i = 0; $_memberrow_i < $_memberrow_count; ++$_memberrow_i){$_memberrow_val = &$this->_tpldata['memberrow'][$_memberrow_i]; if ($this->_rootref['S_SHOW_GROUP']) {  if ($_memberrow_val['S_FIRST_ROW'] && $_memberrow_val['S_GROUP_LEADER']) {  ?>
	...
	<tr>
		...
		<td class="gen<?php if (!($_memberrow_val['S_ROW_COUNT'] & 1)  ) {  ?> row2<?php } else { ?> row1<?php } ?>" align="center">&nbsp;<?php if ($_memberrow_val['U_PM']) {  ?><a href="<?php echo $_memberrow_val['U_PM']; ?>"><?php echo (isset($this->_rootref['PM_IMG'])) ? $this->_rootref['PM_IMG'] : ''; ?></a><?php } ?>&nbsp;</td>
		<td class="gen<?php if (!($_memberrow_val['S_ROW_COUNT'] & 1)  ) {  ?> row2<?php } else { ?> row1<?php } ?>" align="center">&nbsp;<?php if ($_memberrow_val['U_EMAIL']) {  ?><a href="<?php echo $_memberrow_val['U_EMAIL']; ?>"><?php echo (isset($this->_rootref['EMAIL_IMG'])) ? $this->_rootref['EMAIL_IMG'] : ''; ?></a><?php } ?>&nbsp;</td>
		<td class="gen<?php if (!($_memberrow_val['S_ROW_COUNT'] & 1)  ) {  ?> row2<?php } else { ?> row1<?php } ?>" align="center">&nbsp;<?php if ($_memberrow_val['U_WWW']) {  ?><a href="<?php echo $_memberrow_val['U_WWW']; ?>"><?php echo (isset($this->_rootref['WWW_IMG'])) ? $this->_rootref['WWW_IMG'] : ''; ?></a><?php } ?>&nbsp;</td>
		...
		<?php } if ($this->_rootref['S_IN_SEARCH_POPUP'] && ! $this->_rootref['S_SELECT_SINGLE']) {  ?><td align="center" class="gen <?php if (!($_memberrow_val['S_ROW_COUNT'] & 1)  ) {  ?> row2<?php } else { ?> row1<?php } ?>"><input type="checkbox" class="radio" name="user" value="<?php echo $_memberrow_val['USERNAME']; ?>" /></td><?php } ?>
