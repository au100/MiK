	...
	<tr>
		<td class="row1">
		  <?php if ($_user_row_val['USER_IP']) {  ?>
   		    ...
   		    <p class="gen"><?php echo $_user_row_val['USERNAME_FULL_MOD']; ?></p>
   		  <?php } else { ?> 
   		    <p class="gen"><?php echo $_user_row_val['USERNAME_FULL']; ?></p>
   		  <?php } if ($_user_row_val['USER_IP']) {  ?>

		    <p class="gensmall"><?php echo ((isset($this->_rootref['L_IP'])) ? $this->_rootref['L_IP'] : ((isset($user->lang['IP'])) ? $user->lang['IP'] : '{ IP }')); ?>: 
		      <a href="<?php echo $_user_row_val['U_USER_IP']; ?>"><?php echo $_user_row_val['USER_IP']; ?></a> 
		      &#187; 
		      <a href="<?php echo $_user_row_val['U_WHOIS']; ?>" onclick="popup(this.href, 750, 500); return false;"><?php echo ((isset($this->_rootref['L_WHOIS'])) ? $this->_rootref['L_WHOIS'] : ((isset($user->lang['WHOIS'])) ? $user->lang['WHOIS'] : '{ WHOIS }')); ?></a>
		    </p>
		  <?php } if ($_user_row_val['USER_BROWSER']) {  echo $_user_row_val['USER_BROWSER']; } ?>
