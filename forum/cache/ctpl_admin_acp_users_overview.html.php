...
<!-- added by au100 for reputation -->
<dl>
	<dt><label><?php echo ((isset($this->_rootref['L_RP_TOTAL_POINTS'])) ? $this->_rootref['L_RP_TOTAL_POINTS'] : ((isset($user->lang['RP_TOTAL_POINTS'])) ? $user->lang['RP_TOTAL_POINTS'] : '{ RP_TOTAL_POINTS }')); ?>:</label></dt>
	<dd><input type="text" id="user_reputation" name="user_reputation" maxlength="10" size="11" value="<?php echo (isset($this->_rootref['USER_REPUTATION'])) ? $this->_rootref['USER_REPUTATION'] : ''; ?>" /></dd>
</dl>
<!-- end of added -->
...
<?php if (! $this->_rootref['S_USER_FOUNDER'] || $this->_rootref['S_FOUNDER']) {  ?>
	...
	<div style="display: none;" id="delete_reason_area">
        ...
        <!-- end: Prime Trash Bin (Posts) --><?php if (! $this->_rootref['S_OWN_ACCOUNT']) {  ?>
	...
	<fieldset>
		...
		<dl>
			...
			<dd><select id="delete_type" name="delete_type">
                              <option class="sep" value=""><?php echo ((isset($this->_rootref['L_SELECT_OPTION'])) ? $this->_rootref['L_SELECT_OPTION'] : ((isset($user->lang['SELECT_OPTION'])) ? $user->lang['SELECT_OPTION'] : '{ SELECT_OPTION }')); ?></option>
                              <option value="retain"><?php echo ((isset($this->_rootref['L_RETAIN_POSTS'])) ? $this->_rootref['L_RETAIN_POSTS'] : ((isset($user->lang['RETAIN_POSTS'])) ? $user->lang['RETAIN_POSTS'] : '{ RETAIN_POSTS }')); ?></option>
                              <option value="remove"><?php echo ((isset($this->_rootref['L_DELETE_POSTS'])) ? $this->_rootref['L_DELETE_POSTS'] : ((isset($user->lang['DELETE_POSTS'])) ? $user->lang['DELETE_POSTS'] : '{ DELETE_POSTS }')); ?></option>
                              <!-- mod: Prime Trash Bin --><?php if ($this->_rootref['S_DELETE_FOREVER']) {  ?>

                                  <option value="remove_forever"><?php echo ((isset($this->_rootref['L_PRIME_FOREVER_WHEN_DELETE_USER'])) ? $this->_rootref['L_PRIME_FOREVER_WHEN_DELETE_USER'] : ((isset($user->lang['PRIME_FOREVER_WHEN_DELETE_USER'])) ? $user->lang['PRIME_FOREVER_WHEN_DELETE_USER'] : '{ PRIME_FOREVER_WHEN_DELETE_USER }')); ?></option>
                                <?php } ?><!-- end: Prime Trash Bin -->
                            </select>
                        </dd>
		</dl>
		<p class="quick">
