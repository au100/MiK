...
<?php } if (sizeof($this->_tpldata['reputation'])) {  ?>
...
<tr>
	<td class="row1" colspan="3">
		...
		<?php $_reputation_count = (isset($this->_tpldata['reputation'])) ? sizeof($this->_tpldata['reputation']) : 0;if ($_reputation_count) {for ($_reputation_i = 0; $_reputation_i < $_reputation_count; ++$_reputation_i){$_reputation_val = &$this->_tpldata['reputation'][$_reputation_i]; if (!($_reputation_val['S_ROW_COUNT'] & 1)  ) {  ?><tr class="row1"><?php } else { ?><tr class="row2"><?php } ?>

			<td><span class="genmed"><?php echo $_reputation_val['POINT']; ?></span></td>
			<td><span class="genmed"><?php echo $_reputation_val['COMMENT']; ?></span></td>
			<td><span class="genmed"><?php echo $_reputation_val['FROM']; ?></span></td>
			<td><span class="genmed"><a href="<?php echo $_reputation_val['U_POST']; ?>"><?php echo $_reputation_val['POST_SUBJECT']; ?></span></a></td>
		<?php }} ?>
...
<tr>
	<td class="row1" colspan="3">
		...
		<?php if ($this->_rootref['REPUTATION_POINTS']) {  ?>

			<tr>
				<td align="<?php echo (isset($this->_rootref['S_CONTENT_FLOW_END'])) ? $this->_rootref['S_CONTENT_FLOW_END'] : ''; ?>" valign="top" nowrap="nowrap"><b class="genmed"><?php echo ((isset($this->_rootref['L_RP_TOTAL_POINTS'])) ? $this->_rootref['L_RP_TOTAL_POINTS'] : ((isset($user->lang['RP_TOTAL_POINTS'])) ? $user->lang['RP_TOTAL_POINTS'] : '{ RP_TOTAL_POINTS }')); ?>: </b></td>
				<td><b class="gen"><?php echo (isset($this->_rootref['REPUTATION_POINTS'])) ? $this->_rootref['REPUTATION_POINTS'] : ''; ?></b></td>
			</tr>			
