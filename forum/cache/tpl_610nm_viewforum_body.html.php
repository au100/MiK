...
<?php } if ($this->_rootref['S_DISPLAY_ACTIVE']) {  ?>
	...
	<?php $_topicrow_count = (isset($this->_tpldata['topicrow'])) ? sizeof($this->_tpldata['topicrow']) : 0;if ($_topicrow_count) {for ($_topicrow_i = 0; $_topicrow_i < $_topicrow_count; ++$_topicrow_i){$_topicrow_val = &$this->_tpldata['topicrow'][$_topicrow_i]; if ($_topicrow_val['S_DELETED']) {  ?>
			...
			<tr class="deleted_topic">
				...
				<td class="row1" colspan="5">
					...
					<?php echo $_topicrow_val['ATTACH_ICON_IMG']; ?> <?php if ($_topicrow_val['S_TOPIC_MOVED']) {  ?><b><?php echo $_topicrow_val['TOPIC_TYPE']; ?></b> <?php } ?><a title="<?php echo ((isset($this->_rootref['L_POSTED'])) ? $this->_rootref['L_POSTED'] : ((isset($user->lang['POSTED'])) ? $user->lang['POSTED'] : '{ POSTED }')); ?>: <?php echo $_topicrow_val['FIRST_POST_TIME']; ?>" href="<?php echo $_topicrow_val['U_VIEW_TOPIC']; ?>" class="topictitle"><?php if ($_topicrow_val['TOPIC_TITLE_COLOUR']) {  ?><span style="color: #<?php echo $_topicrow_val['TOPIC_TITLE_COLOUR']; ?>"><?php } ?> <?php echo $_topicrow_val['TOPIC_TITLE']; if ($_topicrow_val['TOPIC_TITLE_COLOUR']) {  ?></span><?php } ?></a><br /><?php echo $_topicrow_val['DELETED_MSG']; ?>
		...
		<?php } else { ?>
			...
			<td class="row1">
				<?php if ($_topicrow_val['S_UNREAD_TOPIC']) {  ?><a href="<?php echo $_topicrow_val['U_NEWEST_POST']; ?>"><?php echo (isset($this->_rootref['NEWEST_POST_IMG'])) ? $this->_rootref['NEWEST_POST_IMG'] : ''; ?></a><?php } ?>
                                ...
                                <?php echo $_topicrow_val['ATTACH_ICON_IMG']; ?> <?php if ($_topicrow_val['S_HAS_POLL'] || $_topicrow_val['S_TOPIC_MOVED']) {  ?><b><?php echo $_topicrow_val['TOPIC_TYPE']; ?></b> <?php } ?><a <?php if ($_topicrow_val['FIRST_TEXT_HOVER']) {  ?>title="<?php echo $_topicrow_val['FIRST_TEXT_HOVER']; ?>"<?php } else { ?> title="<?php echo ((isset($this->_rootref['L_POSTED'])) ? $this->_rootref['L_POSTED'] : ((isset($user->lang['POSTED'])) ? $user->lang['POSTED'] : '{ POSTED }')); ?>: <?php echo $_topicrow_val['FIRST_POST_TIME']; ?>" <?php } ?> href="<?php echo $_topicrow_val['U_VIEW_TOPIC']; ?>"class="topictitle"><?php if ($_topicrow_val['TOPIC_TITLE_COLOUR']) {  ?><span style="color: #<?php echo $_topicrow_val['TOPIC_TITLE_COLOUR']; ?>"><?php } ?> <?php echo $_topicrow_val['TOPIC_TITLE']; if ($_topicrow_val['TOPIC_TITLE_COLOUR']) {  ?></span><?php } ?></a>
			...
			<td class="row1" width="140" align="center">
				...
				<p class="topicdetails"><?php echo $_topicrow_val['LAST_POST_AUTHOR_FULL']; ?>
					...
					<?php if (! $this->_rootref['S_IS_BOT']) {  ?><a href="<?php echo $_topicrow_val['U_LAST_POST']; ?>"   <?php if ($_topicrow_val['LAST_TEXT_HOVER']) {  ?>title="<?php echo $_topicrow_val['LAST_TEXT_HOVER']; ?>"<?php } ?> >  <?php if ($_topicrow_val['LAST_TEXT_HOVER']) {  echo $_topicrow_val['LAST_POST_IMG']; } else { ?> <?php echo (isset($this->_rootref['LAST_POST_IMG'])) ? $this->_rootref['LAST_POST_IMG'] : ''; ?>  <?php } ?> </a><?php } ?>
...
<?php } if ($this->_rootref['S_DISPLAY_POST_INFO'] || $this->_rootref['TOTAL_TOPICS']) {  ?>
	...
	<?php } ?>
		...
		<?php if (! $this->_rootref['S_IS_BOT'] && $this->_rootref['U_MARK_TOPICS']) {  ?><a href="<?php echo (isset($this->_rootref['U_MARK_TOPICS'])) ? $this->_rootref['U_MARK_TOPICS'] : ''; ?>"><?php echo ((isset($this->_rootref['L_MARK_TOPICS_READ'])) ? $this->_rootref['L_MARK_TOPICS_READ'] : ((isset($user->lang['MARK_TOPICS_READ'])) ? $user->lang['MARK_TOPICS_READ'] : '{ MARK_TOPICS_READ }')); ?></a><?php } if ($this->_rootref['S_WATCH_FORUM_LINK'] && ! $this->_rootref['S_IS_BOT'] && $this->_rootref['U_MARK_TOPICS']) {  ?> | <?php } if ($this->_rootref['S_WATCH_FORUM_LINK'] && ! $this->_rootref['S_IS_BOT']) {  ?><a href="<?php echo (isset($this->_rootref['S_WATCH_FORUM_LINK'])) ? $this->_rootref['S_WATCH_FORUM_LINK'] : ''; ?>"><?php echo (isset($this->_rootref['S_WATCH_FORUM_TITLE'])) ? $this->_rootref['S_WATCH_FORUM_TITLE'] : ''; ?></a><?php } ?>
