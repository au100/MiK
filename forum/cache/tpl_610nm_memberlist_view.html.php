...
<div id="pagecontent">
	...
	<tr>
		...
		<td class="row1">
			...
			<?php }} ?><!-- begin JTS Enterprises My page mod -->
				<tr>
					<td class="gen" align="<?php echo (isset($this->_rootref['S_CONTENT_FLOW_END'])) ? $this->_rootref['S_CONTENT_FLOW_END'] : ''; ?>" nowrap="nowrap" valign="top"><?php echo ((isset($this->_rootref['L_MP_MYPAGES'])) ? $this->_rootref['L_MP_MYPAGES'] : ((isset($user->lang['MP_MYPAGES'])) ? $user->lang['MP_MYPAGES'] : '{ MP_MYPAGES }')); ?>: </td>
					<td><b class="genmed">
						...
						<a href="<?php echo $_pages_val['VIEW_URL']; ?>"><?php echo $_pages_val['PAGE_TITLE']; ?></a><br />
						<?php }} else { ?>

						<?php echo ((isset($this->_rootref['L_MP_MYPAGE_NO'])) ? $this->_rootref['L_MP_MYPAGE_NO'] : ((isset($user->lang['MP_MYPAGE_NO'])) ? $user->lang['MP_MYPAGE_NO'] : '{ MP_MYPAGE_NO }')); ?>
