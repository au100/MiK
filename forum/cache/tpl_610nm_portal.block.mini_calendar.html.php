<?php if (!defined('IN_PHPBB')) exit; ?><table class="tablebg" cellspacing="1" width="100%">
	<tr>
		<th><?php echo ((isset($this->_rootref['L_MINI_CAL_CALENDAR'])) ? $this->_rootref['L_MINI_CAL_CALENDAR'] : ((isset($user->lang['MINI_CAL_CALENDAR'])) ? $user->lang['MINI_CAL_CALENDAR'] : '{ MINI_CAL_CALENDAR }')); ?></th>
	</tr>
	<tr class="row1">
		<td>	
