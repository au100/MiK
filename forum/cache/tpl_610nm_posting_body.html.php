...
<?php if ($this->_rootref['S_COLOUR']) {  ?>

<tr>
	<td class="row1" width="22%"><b class="genmed"><?php echo ((isset($this->_rootref['L_TOPIC_TITLE_COLOUR'])) ? $this->_rootref['L_TOPIC_TITLE_COLOUR'] : ((isset($user->lang['TOPIC_TITLE_COLOUR'])) ? $user->lang['TOPIC_TITLE_COLOUR'] : '{ TOPIC_TITLE_COLOUR }')); ?>:</b></td>
	<td class="row2" width="78%"><input class="post" type="text" name="topic_title_colour" size="10" maxlength="6" tabindex="2" value="<?php echo (isset($this->_rootref['TOPIC_TITLE_COLOUR'])) ? $this->_rootref['TOPIC_TITLE_COLOUR'] : ''; ?>" />&nbsp;&nbsp;<span>[ <a href="<?php echo (isset($this->_rootref['U_COLOR_PALET'])) ? $this->_rootref['U_COLOR_PALET'] : ''; ?>" onclick="popup(this.href, 636, 150, '_swatch'); return false"><?php echo ((isset($this->_rootref['L_COLOUR_SWATCH'])) ? $this->_rootref['L_COLOUR_SWATCH'] : ((isset($user->lang['COLOUR_SWATCH'])) ? $user->lang['COLOUR_SWATCH'] : '{ COLOUR_SWATCH }')); ?></a> ]</span></td>
</tr>
<?php } if ($this->_rootref['S_NEW_TOPIC']) {  $this->_tpl_include('similar_viewtopic.html'); } ?>
