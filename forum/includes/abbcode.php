	...
	**/
	function abbcode_init( )
	{
		...
		$this->abbcode_config = array(
			...
			'ABBC3_HELP_PAGE'		=> append_sid("{$phpbb_root_path}functions_abbcode.$phpEx", 'mode=help'),
			// Link to ABBC3 upload page
			'ABBC3_UPLOAD_PAGE'		=> append_sid("{$abbc3_root_path}functions_abbcode.$phpEx", 'mode=upload'),
			// Link to ABBC3 wizards page
			'ABBC3_WIZARD_PAGE'		=> append_sid("{$abbc3_root_path}functions_abbcode.$phpEx", 'mode=wizards'),
	...
	**/
	function click_pass( $var1, $var2 )
	{
		...
		if ( $valid )
		{
			...
			$redirect = append_sid("{$phpbb_root_path}functions_abbcode.$phpEx", "mode=click&amp;id=$clicks_id");
