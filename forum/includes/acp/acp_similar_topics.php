		...
		*/
		$display_vars = array(
			...
			'vars'	=> array(
				...
				'similar_use_cache'				=> array('lang' => 'SIMILAR_USE_CACHE',			'validate' => 'bool',	'type' => 'radio:yes_no', 'explain' => true),
				'similar_cache_time'			=> array('lang' => 'SIMILAR_USE_CACHE_TIME',	'validate' => 'int:0',	'type' => 'text:7:6', 'explain' => true),
				'similar_boolean_mode'			=> array('lang' => 'SIMILAR_USE_BOOLEAN_MODE',	'validate' => 'bool',	'type' => 'radio:yes_no', 'explain' => true),
		...
		if ($submit)
		{
			...
			set_config('similar_use_cache', $this->new_config['similar_use_cache']);
			set_config('similar_cache_time', $this->new_config['similar_cache_time']);
			set_config('similar_boolean_mode', $this->new_config['similar_boolean_mode']);
			...
			set_config('similar_ignore_forums_ids', (sizeof($mark_ignored_forum)) ? implode("\n", $mark_ignored_forum) : '');
			set_config('similar_noshow_forums_ids', (sizeof($mark_noshow_forum)) ? implode("\n", $mark_noshow_forum) : '');
		...
		$ignore_forums = explode("\n", trim($this->new_config['similar_ignore_forums_ids']));
		$noshow_forums = explode("\n", trim($this->new_config['similar_noshow_forums_ids']));
