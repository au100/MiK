...
//-- begin mod: User Reputation Points by au100 --------------------------------//
...
//                                if(get_trash_forum())
//                                {
//				   $sql = str_replace('AND t.topic_approved', 'AND ((t.topic_deleted_time = 0 AND t.topic_approved) OR t.forum_id = ' . get_trash_forum() . ')', $sql);
//                                }
//                                else
//                                {
//				   $sql = str_replace('AND t.topic_approved', 'AND t.topic_deleted_time = 0 AND t.topic_approved', $sql);
//				}
			}
