...
define('MYPAGE_TABLE',			$table_prefix . 'mypage');
define('MYPAGE_COMMENTS_TABLE',		$table_prefix . 'mypage_comments');
define('MYPAGE_RATINGS_TABLE',		$table_prefix . 'mypage_ratings');
define('MYPAGE_UPLOADS_TABLE',		$table_prefix . 'mypage_uploads');
