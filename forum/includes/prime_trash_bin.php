...
*
* @package phpBB3
* @version $Id: prime_trash_bin.php,v 1.0.6 2008/08/26 17:02:00 primehalo Exp $
...
if (!defined('INCLUDES_PRIME_TRASH_BIN_PHP'))
{
	...
	*/
	function get_stifled_post_msg(&$post_data, $message = '', $title = '')
	{
		...
		$perm_delete_args = "mode=delete&amp;f={$post_data['forum_id']}&amp;t={$post_data['topic_id']}&amp;p={$post_data['post_id']}";
		...
		if ($user->page['page_name'] == "mcp.$phpEx")
		{
			...
			$perm_delete_args = "i={$id}&amp;mode={$mode}&amp;action=delete_post&amp;f={$post_data['forum_id']}&amp;t={$post_data['topic_id']}&amp;post_id_list[]={$post_data['post_id']}";
